...
const ProfilePage = () => {
  ...
  return (
    ...
    <div className='min-h-screen w-full flex flex-col relative justify-center items-center bg-[#F7EAE0] px-3 py-8 overflow-x-hidden'>
      ...
      <div className='w-full max-w-[18.75rem] min-h-[26rem] bg-[#F7EAE0] shadow-2xl shadow-black hover:shadow-2xl hover:shadow-amber-500 rounded-2xl flex flex-col hover:scale-105 transition-all duration-300 ease-in-out'>
