            ...
            <div className="h-full w-full flex flex-col">
                ...
                <div className="h-20 w-full flex items-center">
                    ...
                    <div className="flex items-center gap-2">
                        <button onClick={() => decreaseQuentityHandeler(item?.quentity, item?.productsId?._id)} className="w-8 h-6.5 rounded-[5px] bg-[#8e6cce62] flex justify-center items-center active:scale-95 transition-all duration-150 ease-in-out"><h1 className="mb-1.5">-</h1></button>
                        <h1 className="text-xl">{item?.quentity}</h1>
                        <button onClick={() => increaseQuentityHandler(item?.quentity, item?.productsId?._id)} className="w-8 h-6.5 rounded-[5px] bg-[#8e6cce62] flex justify-center items-center active:scale-95 transition-all duration-150 ease-in-out"><h1 className="mb-1 text-xl">+</h1></button>
                    </div>
