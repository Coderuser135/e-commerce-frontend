                ...
                <div className="p-2 w-[20rem] flex justify-between items-center text-2xl text-[#E4D6A9]">
                    ...
                    <div className='flex justify-between items-center gap-4'>
                        ...
                        <div className='flex justify-between items-center gap-2'>
                            <div className="h-7.5 w-7.5 rounded-full flex justify-around items-center bg-[#c5c5c5] shadow-2xl">
                                <h1 className="text-[15px] font-extrabold">{user?.fullName[0].toUpperCase()}</h1>
                            </div>
